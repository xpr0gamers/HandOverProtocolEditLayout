sap.ui.define([
	...
	return Opa5.extend("sap.Beutlhauser.HandOverProtocolEditLayout.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["sap/Beutlhauser/HandOverProtocolEditLayout/localService/mockserver"], function (mockserver) {
