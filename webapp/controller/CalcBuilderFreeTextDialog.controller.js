sap.ui.define(
    ...
    function (BaseController) {
        ...
        return BaseController.extend("sap.Beutlhauser.HandOverProtocolEditLayout.controller.CalcBuilderFreeTextDialog", {
            /**
            ...
            showDialog: function (oCriteria, oCallbackChange) {
                ...
                this.setModel(
                    new sap.ui.model.json.JSONModel({
                        ...
                        sExpression: oCriteria.ExpressionFreeTextAvailable
                    })
                );
                this.oDialog.open();
            },
            ...
            onCriteriaSelect: function (oEvent) {
                ...
                this.getView().byId("builderFreetext").updateOrCreateItem('"' + sKey + '"');
            },
            onSave: function (){
                const sExpression = this.getView().byId("builderFreetext").getExpression();
                this.oDialog.setBusy(true);
                const sPath = this.getModel("handoverLayout").createKey("/CriteriaItemSet", {
                    Guid: this.oCriteria.Guid,
                });
                const oUpdateCriteria = {
                    ExpressionFreeTextAvailable: sExpression
                };
