sap.ui.define([
	...
	return Opa5.extend("sap.Beutlhauser.HandOverProtocolEditLayout.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "sap.Beutlhauser.HandOverProtocolEditLayout",
					async: true
				},
				hash: oOptions.hash,
		...
		iRestartTheAppWithTheRememberedItem : function (oOptions) {
			...
			this.waitFor({
				success : function() {
					oOptions.hash = "RootItemSet/" + sObjectId;
